    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="mt-1 font-semibold text-xl text-gray-900 dark:text-white leading-tight">Editar cliente</h2>
            </div>
